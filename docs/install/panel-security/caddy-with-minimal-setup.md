...
You need to set a domain name for your Aura panel. Caddy will automatically issue a certificate for this domain.
...
We recommend using [full security setup with MFA](#full) for production environments where you will be issuing API-keys and using [@localzet/aura-subscriptions](/docs/install/aura-subscriptions) for public subscription page.
...
Here you can quickly go to Aura dashboard or manage some of Auth Portal settings.
